            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 min-h-[40vh]">
                <div className="w-full max-w-3xl space-y-8">
                    ...
                    <div className="flex justify-center gap-3 text-sm">
                        ...
                        <button onClick={() => setQuery("Neural Networks")} className="text-blue-400 hover:underline">Neural Networks</button>
                        <button onClick={() => setQuery("Project Quantum")} className="text-blue-400 hover:underline">Project Quantum</button>
                        <button onClick={() => setQuery("Design Systems")} className="text-blue-400 hover:underline">Design Systems</button>
                    </div>
                </div>
            </div>
                ...
                <div className="flex-1 bg-white/5 border-t border-white/10 p-8 animate-in slide-in-from-bottom-5 fade-in duration-300">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4">
                            {/* Mock Results */}
                            <Link href="/mindcloud/graph?node=neural-networks" className="block p-4 rounded-xl border border-white/10 bg-black/50 hover:bg-white/5 cursor-pointer transition-colors">
                            ...
                            <Link href="/mindcloud/journal/entry-1" className="block p-4 rounded-xl border border-white/10 bg-black/50 hover:bg-white/5 cursor-pointer transition-colors">
                                <div className="flex items-center gap-2 mb-1">
