    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4">
            <div className="text-center space-y-6 mb-16">
                <div className="font-sans text-xl text-blue-500 rotate-[-1deg]">
                    {tag}
                </div>
                <div className="relative">
                    <h2 className="text-4xl md:text-5xl font-bold font-sans text-zinc-900 dark:text-white rotate-[-1deg] tracking-tight">
                        {title}
                ...
                <p className="font-sans text-xl text-zinc-600 dark:text-zinc-400 rotate-[-1deg]">
                    {description}
                </p>
            </div>
                        ...
                        <div className="relative p-6">
                            {tier.popular && (
                                <div
                                    ...
                                    font-sans font-bold px-3 py-1 rounded-full rotate-12 text-sm border-2 border-zinc-900"
                                >
                                    Popular!
                                </div>
                            )}
                            ...
                            <div className="mb-6">
                                ...
                                <h3 className="font-sans font-bold text-2xl text-zinc-900 dark:text-white">
                                    {tier.name}
                                </h3>
                            ...
                            <div className="space-y-3 mb-6">
                                {tier.features.map((feature) => (
                                    ...
                                    >
                                        ...
                                        <span className="font-sans text-lg text-zinc-900 dark:text-white">
                                            {feature}
                                        </span>
                                    </div>
                                ))}
                            ...
                            <Button
                                className={cn(
                                    "w-full h-12 font-sans font-bold text-lg relative",
                                    "border-2 border-zinc-900 dark:border-white",
                                    "transition-all duration-300",
